...
External content should retain its provenance and trust status throughout
...
contain the resulting action. High-impact operations, such as sending messages,
modifying records, or disclosing protected data, should additionally require an
independent policy decision or explicit human approval. The approval interface
should display the exact proposed action, destination, recipient, and affected
data rather than relying solely on the model's explanation.

These controls depend on correct provenance labels, sufficiently complete
...
Protected logs should record relevant input provenance, retrieved content,
