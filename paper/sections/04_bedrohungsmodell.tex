...
an attack constructed using internal model information or saved fine-tuning
states. This section defines the assumptions used to interpret the evaluations
of StruQ, SecAlign, and later adaptive attacks.
...
are saved intermediate states of the model, while ASTRA also uses attention
information
\parencites{zou2023universal}
